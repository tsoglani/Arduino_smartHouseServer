...
public class Fr extends JFrame
{
    ...
    public Fr(SH sh)
    {
        ...
        ImageIcon timelIcon=new ImageIcon(SH.path+"/time.png");
        ...
        ImageIcon automationIcon=new ImageIcon(SH.path+"/automation.png");
    ...
    void mainMenu(){
        ...
        speechButton.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
                    if(speechButton.getIcon()==stop_speechIcon){
                        sh.jarvis.deActivate();
                    }else if(speechButton.getIcon()==speechIcon){
                        sh.jarvis.activate();
                    }
                }
            });
